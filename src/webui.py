...
if __name__ == '__main__':
    ...
    with gr.Blocks(title='RVCCloning') as app:

        gr.Label('не спиздил а переформатировал t.me/q00q0q0', show_label=False)
        ...
        with gr.Tab("Основная"):
            ...
            with gr.Accordion('Основные опции'):
                with gr.Row():
                    with gr.Column():
                        rvc_model = gr.Dropdown(voice_models, label='Голосовые модели', info='Папка моделей «rvc_models». После добавления новых моделей в эту папку нажмите кнопку «Обновить».')
        ...
        with gr.Tab('Скачать Модель'):
            ...
            with gr.Tab('From HuggingFace/Pixeldrain URL'):
                ...
                gr.Examples(
                    [
                        ['t.me/q00q0q0 попросить какую нибудь модель на коленях'],
                    ],
